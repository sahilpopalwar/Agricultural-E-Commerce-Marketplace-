...
-- Create stored procedure to change user language
DELIMITER //
CREATE PROCEDURE change_user_language(
    IN p_user_id INT,
...
BEGIN
    ...
    SELECT 'Language changed successfully' AS message;
END //
DELIMITER ;

-- Example usage:
-- CALL change_user_language(1, 'mr'); -- For Marathi
-- CALL change_user_language(1, 'hi'); -- For Hindi
-- CALL change_user_language(1, 'en'); -- For English