...
public class OrderDeliveryController {
    ...
    public ResponseEntity<OrderDeliveryEvent> getDeliveryStatus(@PathVariable String orderId) {
    ...
    public ResponseEntity<OrderDeliveryEvent> getDelivery(@PathVariable String orderId) {
        return getDeliveryStatus(orderId);
    }

    @GetMapping(value = "/{orderId}/stream", produces = MediaType.TEXT_EVENT_STREAM_VALUE)
    public SseEmitter streamDeliveryStatus(@PathVariable String orderId) {
